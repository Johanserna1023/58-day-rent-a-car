...
Esta es una solución del proyecto **Rent a car** como parte del reto de codificación #100DaysOfProjects [Front End Club](https://www.facebook.com/frontendclubfb). La mejor manera de escribir un buen código es programando todos los días🔥.
...
> [!NOTE]
> **No fue necesario utilizar queries**
...
```
Usamos `Javascript` para colocar por defecto la fecha y hora actual en el "Date of pickup" :
